...
class DetailedSolvedProblem extends StatefulWidget {
  const DetailedSolvedProblem({super.key, this.email, this.solvedids});
  final String? email;
  final String? solvedids;

  @override
  State<DetailedSolvedProblem> createState() => _DetailedSolvedProblemState();
}

class _DetailedSolvedProblemState extends State<DetailedSolvedProblem> {
    ...
    return FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final soluimg = problemData['Solution Image'] as String;
